...
(function() {
    ...
    style.textContent = `
        ...
        .highest3-title { font-size: 1.2vw; display: inline-flex; width: 100%; font-weight: bold; height: 5%; background-color: var(--color2); overflow-y: hidden; }
        .highest3-data { overflow-y: auto; height: 88%; }
